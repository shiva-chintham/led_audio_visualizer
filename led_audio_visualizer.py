...
required_frequencies=[63,160,400,1000,2500,6250,1600]
amplitude_values=[0,0,0,0,0,0,0]
...
while running:
    ...
    for b in bars:
        ...
        b.render(screen)
        index=0
        for freqe in required_frequencies:

            temp=(1-abs(get_decibel(pygame.mixer.music.get_pos()/1000.0, freqe)/80))*100
            temp=map(temp,0,100,0,255)
            amplitude_values[index]=temp
            index=index+1
